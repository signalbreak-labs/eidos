...
// LoggingFile returns the generated internal/client/logging.go file that
// provides a request/response trace logging round-tripper.
func LoggingFile() File {
	return Template("internal/client/logging.go", loggingGoTemplate, nil)
}

const loggingGoTemplate = `package client
