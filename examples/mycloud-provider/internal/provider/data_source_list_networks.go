...
func (d *ListNetworksDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "List Networks", Attributes: map[string]schema.Attribute{"items": schema.DynamicAttribute{Computed: true}, "workspace": schema.StringAttribute{Required: true}}}
}
...
func (d *ListNetworksDataSource) readListRemote(ctx context.Context, config *ListNetworksDataSourceModel, resp *datasource.ReadResponse) {
	if d.client == nil {
