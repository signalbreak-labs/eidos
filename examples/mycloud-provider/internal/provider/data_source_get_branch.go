...
func (d *GetBranchDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	reqPath = strings.ReplaceAll(reqPath, "{branch}", config.Branch.ValueString())
