...
var wireNames = map[string]map[string]string{
	...
	"CreatePullRequestActionModel": {
		"body_organization": "organization",
		"body_project":      "project",
	},
	...
	"InstanceResourceModel": {
		"api_version":                         "apiVersion",
		"spec.containers.*.image_pull_policy": "imagePullPolicy",
	},
	"ListConfigsDataSourceModel": {
		"items.*.api_version": "apiVersion",
	},
	"ListInstancesDataSourceModel": {
		"items.*.api_version":                         "apiVersion",
		"items.*.spec.containers.*.image_pull_policy": "imagePullPolicy",
	},
	"ListNetworksDataSourceModel": {
		"items.*.api_version":          "apiVersion",
		"items.*.spec.ip_address":      "ipAddress",
		"items.*.status.load_balancer": "loadBalancer",
	},
	"ListSecretsDataSourceModel": {
		"items.*.api_version": "apiVersion",
	},
	"ListStacksDataSourceModel": {
		"items.*.api_version":           "apiVersion",
		"items.*.status.ready_replicas": "readyReplicas",
	},
	"ListWorkspacesDataSourceModel": {
		"items.*.api_version": "apiVersion",
	},
	"NetworkResourceModel": {
		"api_version":          "apiVersion",
		"spec.ip_address":      "ipAddress",
		"status.load_balancer": "loadBalancer",
	},
	"SecretResourceModel": {
		"api_version": "apiVersion",
	},
	"StackResourceModel": {
		"api_version":           "apiVersion",
		"status.ready_replicas": "readyReplicas",
	},
	"UpdatePullRequestActionModel": {
		"body_organization": "organization",
		"body_project":      "project",
		"body_pull_number":  "pull_number",
	},
	"UpdateTaskActionModel": {
		"body_organization": "organization",
		"body_project":      "project",
		"body_task_number":  "task_number",
	},
